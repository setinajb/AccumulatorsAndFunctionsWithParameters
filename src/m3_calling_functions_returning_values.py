...
def run_test_digits_in_cube():
    ...
    expected5 = 1
    answer5 = digits_in_cube(1)
    print('expected:', expected5)
    print('actual:', answer5)

    expected6 = 8
    answer6 = digits_in_cube(2)
...
def digits_in_cube(n):
    ...
    cube = n ** 3
    sum_of_cube = sum_of_digits(cube)
...
def run_test_digits_in_power():
    ...
    expected6 = 4
    answer6 = digits_in_power(2, 2)
    print('expected:', expected6)
    print('actual:', answer6)

    expected7 = 7
    answer7 = digits_in_power(4, 2)
    print('expected:', expected7)
    print('actual:', answer7)

    expected8 = 9
    answer8 = digits_in_power(3, 3)
...
def digits_in_power(n, k):
    ...
    digit_to_power = n ** k
    y = sum_of_digits(digit_to_power)
...
def run_test_fancy_sums_of_digits():
    ...
    expected7 = 1
    answer7 = fancy_sums_of_digits(10)
    print('expected:', expected7)
    print('actual:', answer7)

    expected8 = 19084
    answer8 = fancy_sums_of_digits(2)
    print('expected:', expected8)
    print('actual:', answer8)

    expected9 = 124309
    answer9 = fancy_sums_of_digits(35)
...
def fancy_sums_of_digits(n):
    ...
    x_cor = n ** 1000
    sum_x = sum_of_digits(x_cor)

    y_cor = n ** 999
    sum_y = sum_of_digits(y_cor)
